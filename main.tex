...
\end{lstlisting}   
    ...
    \item This is the overview of making \lstinline|derive|:
    \begin{enumerate}
      \item Check if the instance for the input type has been defined.
      \item If not, split the type into either tuple like or enum like.
      \item Create the \emph{ill-typed} instances list of \lstinline|TestObject| using \lstinline|erasedValue| \label{enum:instances_list}.
