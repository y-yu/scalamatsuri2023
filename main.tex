...
\begin{frame}[fragile]
  \frametitle{\ballcircle{4b} \lstinline|SumOf[A]| case}
...
\end{lstlisting}
  ...
  \note{
    \begin{itemize}
      ...
      \item \lstinline|minBy(_.getClass.getName)|と\lstinline|maxByOption(_.getClass.getName)|はなんなのか？
    \end{itemize}
  }
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
    \item I don't know why, anyway shapeless 2 sorts the instances by its type name.

    \item On the other hand, \lstinline|MirroredElemTypes| in Scala 3 are sorted by the definitions in source code.

    \item So the \lstinline|minBy| and \lstinline|maxByOption| is for compatibility of shapeless 2 behavior.
  \end{itemize}
